...
cc_binary(
    ...
    copts = [
        # "-std=c99",
        "-Iexternal/_main~load_external_repos~asn1c",
        "-Iexternal/_main~load_external_repos~asn1c/asn1c",
        "-Iexternal/_main~load_external_repos~asn1c/libasn1common",
        "-Iexternal/_main~load_external_repos~asn1c/libasn1compiler",
        "-Iexternal/_main~load_external_repos~asn1c/libasn1parser",
        "-Iexternal/_main~load_external_repos~asn1c/libasn1fix",
        "-Iexternal/_main~load_external_repos~asn1c/libasn1print",
        "-Iexternal/_main~load_external_repos~asn1c/skeletons",
    ],
    local_defines = [
        "HAVE_CONFIG_H",
